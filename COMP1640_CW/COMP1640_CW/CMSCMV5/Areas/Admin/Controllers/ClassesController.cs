...
namespace CMSCMV5.Areas.Admin.Controllers
{
    public class ClassesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "IDClass,Subject,Course,Department,Title,Description")] Class @class)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "IDClass,Subject,Course,Department,Title,Description")] Class @class)
        {
            if (ModelState.IsValid)
            {
